...
?>
<header>
  <div class="logo"><?php echo $organizationName;?></div>
  <ul>
    <!--<li>Help</li>-->
    <li class="active">Dashboard</li>
    <li style="cursor:pointer"><a href="/?disconnect=1">Disconnect</a></li>
  </ul>
</header>
...
<section id="wrapper">
  ...
  <script src="/vendor/jquery-top-droppable/jquery.top-droppable.js"></script>
